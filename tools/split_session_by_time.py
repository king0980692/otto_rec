...
parser.add_argument('--train_pq', type=str, required=True)
parser.add_argument('--test_pq', type=str, required=True)
parser.add_argument('--out', type=str, required=True)

args = parser.parse_args()
train = pd.read_parquet(args.train_pq)
test = pd.read_parquet(args.test_pq)
'''
